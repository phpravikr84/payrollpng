                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('personal_event_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="form-control" rows="8" name="personal_event_description" id="personal_event_description" placeholder="{{ __('Enter client description..') }}">{{ old('personal_event_description') }}</textarea>
                                @if ($errors->has('personal_event'))
                                <span class="help-block">
