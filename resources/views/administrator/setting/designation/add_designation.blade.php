                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('designation_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="form-control" rows="8" name="designation_description" id="designation_description" placeholder="{{ __('Enter client description..') }}">{{ old('designation_description') }}</textarea>
                                @if ($errors->has('designation'))
                                <span class="help-block">
