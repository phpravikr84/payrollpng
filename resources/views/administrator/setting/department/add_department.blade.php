                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('department_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="form-control" rows="8" name="department_description" id="department_description" placeholder="{{ __('Enter client description..') }}">{{ old('department_description') }}</textarea>
                                @if ($errors->has('department'))
                                <span class="help-block">
