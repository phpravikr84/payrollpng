                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('job_type_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="form-control" rows="8" name="job_type_description" id="job_type_description" placeholder="{{ __('Enter job description..') }}">{{ old('job_type_description') }}</textarea>
                                @if ($errors->has('job_type'))
                                <span class="help-block">
