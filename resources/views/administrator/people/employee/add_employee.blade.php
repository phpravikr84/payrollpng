                        ...
                        <form action="{{ url('people/employees/store') }}" method="post" name="employee_add_form">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <label for="state">{{ __('Postcode') }} <span class="text-danger">*</span></label>
                                        <div class="form-group">
                                            <input type="text" name="state" id="state" class="form-control" placeholder="{{ __('Enter state.') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <label for="emergency_contact">{{ __('Country') }}</label>
                                        <div class="form-group">
                                            <input type="text" name="emergency_contact" id="emergency_contact" class="form-control" placeholder="{{ __('Enter pincode..') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <h4 class="box-title">{{ __('PASSPORT & VISA DETAILS') }}</h3>
                                    </div>
                                    <div class="col-md-6">
