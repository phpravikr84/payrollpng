                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('deduction_description') ? ' has-error' : '' }} has-feedback">
                                <textarea class="form-control" rows="8"name="deduction_description" id="deduction_description" placeholder="{{ __('Enter client description..') }}">{{ old('deduction_description') }}</textarea>
