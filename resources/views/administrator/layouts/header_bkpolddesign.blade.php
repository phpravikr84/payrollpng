<header class="main-header">
    ...
    <a href="{{ url('/dashboard') }}" class="logo">
        ...
        <span class="logo-mini">
                        <img src="{{ asset('profile_picture/comp-logo.png') }}" class="user-image" alt="User Image">
                    </span>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        @else
                        <img src="{{ asset('profile_picture/blank_profile_picture.png') }}" class="user-image" alt="User Image" width="160px">
                        @endif
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            @else
                            <img src="{{ asset('profile_picture/blank_profile_picture.png') }}"  class="img-circle" alt="User Image" width="160px">
                            @endif
                            <p>
                                {{ Auth::user()->name }}
