...
class EmpReferenceController extends Controller {
	...
	public function create() {
		$designations = Designation::where('deletion_status', 0)
			...
			return view('administrator.people.reference.add_reference', compact('designations')); //Change By Me
	}
	...
	public function edit($id) {
		...
		return view('administrator.people.reference.edit_reference', compact('reference', 'designations')); //Change by me
	}
